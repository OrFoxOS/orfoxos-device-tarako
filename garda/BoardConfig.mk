...
TARGET_BOOTLOADER_BOARD_NAME := garda
...
UBOOT_DEFCONFIG := garda
else
UBOOT_DEFCONFIG := garda_native
endif

# config kernel
TARGET_NO_KERNEL := false
ifeq ($(TARGET_VLX_ENABLE), true)
KERNEL_DEFCONFIG := garda-vlx_defconfig
else
KERNEL_DEFCONFIG := garda-native_defconfig
endif
...
TARGET_RECOVERY_UI_LIB := librecovery_ui_garda
...
TARGET_BOARD_FRONT_CAMERA_SUPPORT := false
